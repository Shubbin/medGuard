  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:bg-blue-700 z-50"
      >
        💬
      </button>
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-[95vw] sm:w-96 h-[75vh] bg-white shadow-xl rounded-xl flex flex-col z-50 overflow-hidden border border-gray-300">
          ...
          <main className="flex-1 flex flex-col p-3 overflow-y-auto bg-gray-50">
            ...
            {isLoading && (
              <div className="flex justify-start mb-3">
                <div className="p-3 rounded-lg bg-gray-200 text-gray-800 shadow max-w-[80%]">
                  <div className="flex items-center">
                    <span className="dot-flashing"></span>
                    <span className="ml-2">Typing...</span>
                  </div>
          ...
          <div className="flex items-center p-3 bg-white border-t border-gray-200">
            <input
              type="text"
              placeholder="Type your message..."
              className="flex-1 p-2 border border-gray-300 rounded-l-lg focus:outline-none text-sm"
              value={input}
              onChange={(e) => setInput(e.target.value)}
              onKeyPress={handleKeyPress}
              disabled={isLoading}
            ...
            <button
              onClick={handleSendMessage}
              className="bg-blue-600 text-white px-4 py-2 rounded-r-lg hover:bg-blue-700 disabled:opacity-50 text-sm"
              disabled={isLoading}
            >
              Send
            </button>
