  ...
  return (
    <div>
      <section aria-labelledby="stats-heading" className="p-4" role="region">
        <div className="flex gap-64 mb-10 mt-14">
          ...
          <div>
            ...
            <button className="flex items-center gap-2 px-6 py-2 mt-4 text-lg border border-black rounded-md">
        ...
        <motion.div
          initial="hidden"
          animate="visible"
          className="grid grid-cols-1 gap-6 text-center md:grid-cols-4"
        >
          {stats.map((stat, index) => (
            <motion.div key={index} className="">
              <div className="flex flex-col">
                <p className="text-4xl font-normal text-primary font-rubik">
                  {stat.value}
                </p>
