...
const MobileDashboardBar = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex items-center justify-between px-4 py-2 bg-secondary-dark">
        <div className="flex gap-4 items-center">
          <img src={logo} className="h-24" alt="MedGuard Logo" />
          <h1 className="text-lg md:text-4xl font-bold text-white">Welcome Back, Mac</h1>
        </div>
      ...
      <div className="w-full flex justify-around bg-white py-2 border-t border-gray-200">
