...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary-dark text-white py-10 mt-16">
      <div className="container mx-auto px-4">
        ...
        >
          <ul className="flex flex-wrap justify-center space-x-6 text-sm font-medium">
            ...
            <li><Link to="/privacy" className="hover:text-primary transition">Privacy and Policy</Link></li>
            <li><Link to="/terms" className="hover:text-primary transition">Terms and conditions</Link></li>
          </ul>
        </nav>

        {/* Socials */}
        <div className="flex justify-center space-x-6 mt-6" aria-label="Social media links">
        ...
        <div className="text-center mt-8 border-t border-gray-600 pt-4 text-sm text-gray-300">
          <p>&copy; {currentYear} <span className="font-semibold">MedGuard</span>. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
